...
enum TestVariant:
	case NoVariant, NoVar6, Rainbow5, Black5, White5, Pink5, Brown5, Prism5, Muddy5, Cocoa5, Omni5, Null5, Orange5, DBrown5, DOrange5, PinkLPink6
...
val VARIANTS = Map(
	...
	TestVariant.DOrange5	-> Variant(2135, "Dark Orange (5 Suits)",  Vector("Red", "Yellow", "Green", "Blue", "Dark Orange"),    shorts = Some(Vector('r', 'y', 'g', 'b', 'o'))),
