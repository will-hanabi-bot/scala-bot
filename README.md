...
It can play with [Reactor 1.0](https://hanabi.wiki/en/conventions/reactor) (3p only), [Referential Sieve](https://hackmd.io/Ui6LXAK3TdC7AKSDcN20PQ?view), or [H-Group](https://hanabi.github.io/) (up to level 10) conventions. Just like my other bots, it does not do any "learning" during the game.
